...
public class PercetronLearnerController implements TableItemControls{
   ...
   private class ParameterSelectionListener implements ListChangeListener< Integer > {
   ...
   @FXML private void initialize(){
      ...
      parameterTable.getSelectionModel().getSelectedIndices().addListener( new ParameterSelectionListener() );
   }
