...
public class BuilderObjectCommands {
   ...
   private static final String CREATE_COMMAND_DESCRIPTION = "Function to create a new Object using a Definition.";
   ...
   public static final Command< BuilderObject > CREATE_BUILDER_OBJECT_COMMAND = new ParameterizedCommandImpl< BuilderObject >(
            ...
            BuilderObjectCommandParameters.DEFINITION_REFERENCE_PARAMETER
   );
