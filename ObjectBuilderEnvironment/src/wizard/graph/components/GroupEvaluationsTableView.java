...
import wizard.graph.GraphWizardConfiguration;
...
public class GroupEvaluationsTableView extends VBox {
   ...
   private void createTable(){
      ...
      table.setPrefHeight( GraphWizardConfiguration.dualListHeight() );
   }//End Method
   ...
   private void createEvaluationColumn(){
      ...
      column.setCellFactory(ComboBoxTableCell.forTableColumn( new EnumStringConverter< GroupEvaluation >( GroupEvaluation.class ), availableGroupEvaluations ));
      column.setCellValueFactory( value -> {
      ...
      column.setPrefWidth( GraphWizardConfiguration.dualListWidth() );
      Workarounds.disableColumnDragging( column );
      table.getColumns().add( column );
   }//End Method
